...
export const FloatingButtons = () => {
  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center space-y-12">
      {/* Botón de WhatsApp */}
      <div className="relative">
        <Button
          ...
          size="sm"
        >
          <MessageCircle size={16} fill="currentColor" className="flex-shrink-0 ml-1" />
      ...
      <div className="relative">
        <Button
          ...
          size="sm"
        >
          <Phone size={16} className="flex-shrink-0 ml-1" />
