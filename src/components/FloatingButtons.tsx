  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col space-y-3">
      ...
      <Button
        ...
        className="bg-[#25D366] hover:bg-[#25D366] text-white shadow-xl hover:shadow-2xl transition-all duration-300 rounded-full w-10 h-10 hover:w-auto hover:px-4 flex items-center justify-center group opacity-60 hover:opacity-100"
        size="sm"
      >
      ...
      <Button
        ...
        className="bg-destructive hover:bg-destructive/90 text-destructive-foreground shadow-xl hover:shadow-2xl transition-all duration-300 rounded-full w-10 h-10 hover:w-auto hover:px-4 flex items-center justify-center group opacity-60 hover:opacity-100"
        size="sm"
      >
